...
```
postgresql://postgres.jsvndsaltnblsydzrxjd:boluwatife21@aws-1-eu-north-1.pooler.supabase.com:6543/postgres
```
...
```bash
docker run -it --rm postgres:15-alpine psql "postgresql://postgres.jsvndsaltnblsydzrxjd:boluwatife21@aws-1-eu-north-1.pooler.supabase.com:6543/postgres"
```
